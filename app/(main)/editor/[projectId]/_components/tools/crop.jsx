...
const CropContent = () => {
    ...
    const applyCrop = () => {
        ...
        try {
            ...
            toast.error("Fail to crop. Please try again");
            exitCropMode();
        }
    };
            ...
            {isCropMode && (
                <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-3">
                    ...
                    <p className="text-cyan-300/80 text-xs mt-1">
                        Adjust the green rectangle to set crop area
                    </p>
                </div>
            )}
            ...
            {isCropMode && (
                        ...
                        <div className="bg-slate-700/30 rounded-lg p-3">
                            <p className="text-xs text-white/70">
                                ...
                                <br />
                                2. Drag the green rectangle to select crop area
                                <br />
