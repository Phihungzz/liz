...
const TextControls = () => {
    ...
    const toggleFormat = (format) => {
        ...
        switch (format) {
            case "bold": {
                const current = selectedText.fontWeigth || "normal";
                selectedText.set(
                    "fontWeight",
        ...
        <div className="space-y-6">
            <div className="space-y-4">
                <div>
                    ...
                    <p className="text-xs text-white/70 mb-4">
                        Click to add edit text in your canvas
                    </p>
                </div>
                ...
                <div className="border-t border-white/10 pt-6">
                    ...
                    <div className="space-y-2 mb-4">
                        ...
                        <Button
                            ...
                            variant={
                                selectedText.fontWeigth === "bold" ? "default" : "outline"
                            }
                            size="sm"
                            className="flex-1"
                        >
            ...
            <div className="bg-slate-700/30 rounded-lg p-3">
                <p className="text-xs text-white/70">
                    <strong>Double Click</strong> any text to edit.
                    <br />
                    <strong>Select</strong> text to see formatting option here.
                </p>
            </div>
        </div>
    );
