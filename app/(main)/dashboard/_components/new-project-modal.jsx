...
const NewProjectModal = ({ isOpen, onClose }) => {
    ...
    const handleCreateProject = async () => {
        ...
        try {
            ...
            //create project trong cua convex
                            ...
                            <AlertDescription className="text-amber-300/80">
                                <div className="font-semibold text-amber-400 mb-1">
                                    ...
                                    {currentProjectCount === 2 
                                        ...
                                        : "Free plan is limited to 5 projects. Upgrade to Pro to create more projects."
                                    }
                                </div>
                            </AlertDescription>
                        </Alert>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    className="bg-slate-700 border-white/20 text-white placeholder-white/50 focus:border-blue-400 focus:ring-blue-400"
                                />
                        </div>
